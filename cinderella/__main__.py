...
_Maintained by_ [DeVAJe](tg://user?id={})
"""
...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="💻Help💻",callback_data="help_back"),InlineKeyboardButton(text="🛡Creator🛡",url="https://t.me/PSCreater")]]
